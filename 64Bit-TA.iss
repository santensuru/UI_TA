...
[Files]
Source: "C:\Users\user\Documents\Visual Studio 2013\Projects\UI_TA\UI_TA\bin\Debug\*"; DestDir: "{app}";

[Icons]
Name: "{group}\AHLZWO"; Filename: "{app}\UI_TA.exe"; WorkingDir: "{app}"
Name: "{group}\Uninstall AHLZWO"; Filename: "{uninstallexe}"
